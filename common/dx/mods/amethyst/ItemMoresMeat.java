...
public class ItemMoresMeat extends ItemFood
{
    ...
    public ItemMoresMeat(int par1, int par2, float par3, boolean par4, int par5)
    {
        ...
        if (par5 == 1) {
        	this.setPotionEffect(Potion.hunger.id, 30, 0, 0.5F);
        }
    }

    public ItemMoresMeat(int par1, int par2, float par3, boolean par4)
    {
